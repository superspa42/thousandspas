...
//	private boolean isExperienceSectionFilled = true;
	...
	public void fillCompletionStatus(Spa spa){
		if(spa.getOwnerFirstName() == null || "".equals(spa.getOwnerFirstName().trim())
				|| spa.getOwnerLastName() == null || "".equals(spa.getOwnerLastName().trim())
				|| spa.getPrimaryEmail() == null || "".equals(spa.getPrimaryEmail().trim())
				|| spa.getMobile() == null || "".equals(spa.getMobile().trim())
				|| spa.getBusinessPhone1() == null || "".equals(spa.getBusinessPhone1().trim())
